...
export function Navigation({ items, showConnectWallet = true, onConnectWalletClick }: NavigationProps) {
  ...
  return (
    // pt matches the px-4/md:px-8 side insets so the logo and wallet
    // button sit equidistant from the viewport corner.
    <div className="fixed z-50 pt-4 md:pt-8 top-0 left-0 w-full bg-black/80 backdrop-blur-md">
